...
public class StrUtils {
    ...
    public static String join(boolean newVesion,CharSequence delimiter, CharSequence... elements) {
        if (newVesion) {
            ...
            if(elements!=null){
                ...
                joiner.append(elements[elements.length-1]);
                return joiner.toString();
            }else{
                return delimiter==null? "":delimiter.toString();
            }
        }
    }
}
